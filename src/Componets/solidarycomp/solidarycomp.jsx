...
//       hola este es el componente solidario
  ...
  return (
    <div className="pedido-view">
      ...
      <div className="imagenes-desplazables">
        ...
        <img src="https://res.cloudinary.com/dq2tfglqq/image/upload/v1699188503/IMG_7020_l7rywz_1_-removebg-preview_xka4xr.png" alt="Imagen 1" />
        <img src="https://res.cloudinary.com/dq2tfglqq/image/upload/v1699188503/IMG_7058._nb0z2u_1_-removebg-preview_werd0w.png" alt="Imagen 2" />
        <img src="https://res.cloudinary.com/dq2tfglqq/image/upload/v1699188503/IMG_7016_xcyakf_1_-removebg-preview_jomse0.png" alt="Imagen 3" />
        <img src="https://res.cloudinary.com/dq2tfglqq/image/upload/v1698773938/IMG-20231029-WA0098_pfxyej.jpg" alt="Imagen 4" />
        <img src="https://res.cloudinary.com/dq2tfglqq/image/upload/v1699188503/IMG_7022_ahj80b_1_-removebg-preview_virgkz.png" alt="Imagen 5" />
      </div> */}
